            ...
            <div class="row">
                <div class="column side">
                    ...
                    <div class="leftDiv">
                        ...
                        <!--Trending part-->
                        <p>Trends</p>
                        <c:forEach items="${sessionScope.trends}" var="trend">
                            <p><a href="membership?action=hashtag&hashName=${trend}">#${trend}</a></p>
                ...
                <div class="column middle">
                    <div class="leftDiv">
                        ...
                        <div>
                            ...
                            <c:forEach items="${sessionScope.twits}" var="twit">
                                <dl>
                                    <dt>
                                ...
                                <div><img src="${pageContext.request.contextPath}/lib/${user.profilePicture}" class="smallAvatar" align="left" />
                                    ...
                                    <span>
                                        ...
                                        <form action="membership" method="get">
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.followedUsers.containsKey(username)}">
